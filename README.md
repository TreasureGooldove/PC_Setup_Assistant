...
已有：本地演示、需求对话、三套方案、兼容性规则、持久化 Worker、SSE、生成进度条、导出、扩展硬件天梯、八品类候选扩容、固定白名单目录同步、厂商/系列/价格筛选、型号直接换件、独立商品详情、京东/拼多多报价状态、受控京东公开参数解析、游戏最低/推荐配置查询和 CI。
